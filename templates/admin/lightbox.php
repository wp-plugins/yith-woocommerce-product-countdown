...
<div class="widget-content">
    <p style="margin-top:0;">
        <label for="ywpc_product_search"><?php _e( 'Products to show', 'ywpc' ); ?></label>
        <input type="hidden" class="wc-product-search" id="ywpc_product_search" name="ywpc_product_search" data-placeholder="<?php _e( 'Search for a product&hellip;', 'ywpc' ) ?>" data-action="woocommerce_json_search_products" data-multiple="true" data-selected="" value="" />
    </p></div>
<div class="widget-control-actions">
    <div class="alignright">
        <input type="submit" name="ywpc_shortcode_insert" id="ywpc_shortcode_insert" class="button" value="<?php _e( 'Insert', 'ywpc' ); ?>">
    </div>
    <br class="clear">
</div>
<script type="text/javascript">
    jQuery(document).on('click', '.button', function () {
        ...
        var code = jQuery('#ywpc_product_search').val(),
